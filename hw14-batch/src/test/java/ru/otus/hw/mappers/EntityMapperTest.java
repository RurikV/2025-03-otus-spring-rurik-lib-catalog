...
class EntityMapperTest {
    ...
    void shouldMapMongoAuthorToJpaAuthor() {
        ...
        assertThat(author.getId()).isEqualTo(0L); // ID will be generated by database
    ...
    void shouldMapMongoGenreToJpaGenre() {
        ...
        assertThat(genre.getId()).isEqualTo(0L); // ID will be generated by database
    ...
    void shouldMapMongoBookToJpaBook() {
        ...
        assertThat(book.getId()).isEqualTo(0L); // ID will be generated by database
        assertThat(book.getTitle()).isEqualTo("War and Peace");
        assertThat(book.getAuthor()).isNotNull();
        assertThat(book.getAuthor().getId()).isEqualTo(0L); // ID will be generated by database
        assertThat(book.getAuthor().getFullName()).isEqualTo("Leo Tolstoy");
        assertThat(book.getGenres()).hasSize(2);
        assertThat(book.getGenres().get(0).getId()).isEqualTo(0L); // ID will be generated by database
        assertThat(book.getGenres().get(1).getId()).isEqualTo(0L); // ID will be generated by database
    }
