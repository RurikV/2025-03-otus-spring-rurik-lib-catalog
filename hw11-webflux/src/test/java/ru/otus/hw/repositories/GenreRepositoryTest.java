...
class GenreRepositoryTest {
    ...
    void shouldSaveGenre() {
        ...
        // Act
        Genre savedGenre = genreRepository.save(expectedGenre).block();
        Genre retrievedGenre = genreRepository.findById(savedGenre.getId()).block();
    ...
    void shouldFindAllGenresByIds() {
        ...
        // Act
        List<Genre> foundGenres = genreRepository.findAllByIds(genreIds).collectList().block();
